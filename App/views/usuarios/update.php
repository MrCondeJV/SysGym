            ...
            <div class="row mb-4">
                <div class="col-sm-12 text-center">
                    <div class="p-4 rounded shadow-lg"
                        style="background: linear-gradient(90deg,rgb(5, 99, 32),rgb(51, 240, 114)); color: #fff; font-family: 'Arial', sans-serif;">
                            ...
                            <form action="../../controllers/usuarios/update.php" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="password" name="contrasena_hash" class="form-control"
                                            id="contrasena_hash">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="password" name="contrasena_hash_repeat" class="form-control"
                                            id="contrasena_hash_repeat">
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="rol" class="form-control" required>
                                            ...
                                            <option value="<?= $roles_dato['id']; ?>"
                                                <?= ($roles_dato['id'] == ($usuario['rol'] ?? '')) ? 'selected' : ''; ?>>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="tel" name="telefono" class="form-control"
                                            placeholder="Escriba el teléfono..." pattern="[0-9]{10}" maxlength="10"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="estado" class="form-control" required>
                                            <option value="activo"
                                                <?= ($usuario['estado'] ?? '') === 'activo' ? 'selected' : ''; ?>>Activo
                                            </option>
