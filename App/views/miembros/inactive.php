...
include('../../controllers/miembros/list_miembros_inactivos.php');
                                        ...
                                        foreach ($miembros_datos as $miembro) {
                                            ...
                                            <tr id="row-<?php echo $id_miembro; ?>">
                                                <td class="align-middle"><?php echo ++$contador; ?></td>
                                                                                                <td class="align-middle"><?php echo htmlspecialchars($miembro['numero_documento']); ?></td>
                                                ...
                                                <td class="align-middle">
                                                    <?php if (strtolower($miembro['estado']) === 'activo'): ?>
                                                        <span class="badge badge-success" style="font-size:1em;padding:6px 14px;">
                                                            <?php echo htmlspecialchars($miembro['estado']); ?>
                                                        </span>
                                                    <?php else: ?>
                                                        <span class="badge badge-secondary" style="font-size:1em;padding:6px 14px;">
                                                            <?php echo htmlspecialchars($miembro['estado']); ?>
                                                        </span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="align-middle">
                                                    <div class="btn-group">
                                                        ...
                                                        <!-- Botón de Activacion con SweetAlert2 -->
