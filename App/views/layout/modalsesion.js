$(document).ready(function () {
  let sessionDuration = 18000; // 5 horas en segundos
  let warningTime = 60; // 1 minuto de advertencia (puedes aumentarlo si quieres)
  ...
  function closeSession() {
    ...
    window.location.href = window.location.origin + "/login/index.php";
  }

  function renewSession() {
    //console.log("Renovando sesión...");
    fetch("/layout/sesion.php?renew=true")
